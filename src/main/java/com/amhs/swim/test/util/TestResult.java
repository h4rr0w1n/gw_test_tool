...
public class TestResult {
    ...
    private String swimReceiveStatus;
    private String amhsReceiveStatus = "(manual verify)";
    private String result = "(manual)";

    /**
     * Constructs a result record for a specific message attempt.
     */
    public TestResult(String caseCode, int attempt, int messageIndex, String payloadSummary, String sendStatus, String swimReceiveStatus) {
        this.caseCode = caseCode;
        this.attempt = attempt;
        this.messageIndex = messageIndex;
        this.payloadSummary = payloadSummary;
        this.sendStatus = sendStatus;
        this.swimReceiveStatus = swimReceiveStatus;
    }
    ...
    public String getSwimReceiveStatus() { return swimReceiveStatus; }
    public String getAmhsReceiveStatus() { return amhsReceiveStatus; }
